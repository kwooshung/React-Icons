...
| ---------- | ----------- | ------------- | ------------- | -------- |
| icongroup  | Icon group  | `IIconList[]` | `[]`          | Yes      |
...
| Parameters       | Description                                                                                                            | Type                                                 | Default value | Required |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------------- | -------- |
| type             | Fill type                                                                                                              | `fill`\|`line`                                       | `fill`        | No       |
| name             | Icon name                                                                                                              | `string`                                             | -             | Yes      |
| viewBox          | View box, does not affect `svg`, only when the child element `symbol` does not exist, this value is automatically used | `string`                                             | -             | Yes      |
| path             | `Path` tag attribute                                                                                                   | `TExtendedSVGPathProps` \| `TExtendedSVGPathProps[]` | -             | Yes      |
